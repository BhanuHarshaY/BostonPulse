          ...
          {run.answer && (
            <div>
              ...
              <div className="rounded-xl bg-black/20 border border-(--border) p-4">
                <div className="text-sm text-(--cream)/80 leading-relaxed prose prose-invert prose-sm max-w-none [&>*:first-child]:mt-0 [&>*:last-child]:mb-0 [&_ul]:my-1 [&_li]:my-0.5 [&_p]:my-1 [&_strong]:text-(--cream) [&_h1]:text-base [&_h2]:text-sm [&_h3]:text-sm [&_h1]:font-semibold [&_h2]:font-semibold [&_h3]:font-semibold [&_h1]:mt-2 [&_h2]:mt-2 [&_h3]:mt-1.5">
